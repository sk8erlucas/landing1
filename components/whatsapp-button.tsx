...
export default function WhatsAppButton() {
  const openWhatsApp = () => {
    ...
    const message = "¡Hola! Me interesa conocer más sobre los préstamos para electrodomésticos. ¿Podrían ayudarme?"
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute right-16 top-1/2 transform -translate-y-1/2 bg-white text-gray-800 px-4 py-2 rounded-lg shadow-lg whitespace-nowrap"
      >
